...
dashboard_agent = Agent(
    ...
    instructions=[
        ...
        "Use these approaches for visualizations:",
        "1. Chart.js for interactive charts (line, bar, pie, doughnut)",
        "2. Clean HTML/CSS cards for KPI displays",
        "3. CSS Grid layouts for professional dashboard structure",
        "4. JavaScript for interactivity and data binding",
        "Always query the 'data' table first using DuckDB to get real insights.",
        "Generate complete HTML files with embedded CSS and JavaScript.",
        "Include Chart.js CDN: https://cdn.jsdelivr.net/npm/chart.js",
        "Create responsive designs with modern styling.",
        "Save all HTML dashboards in the output folder.",
        "Include actual data insights as text cards in the dashboard.",
